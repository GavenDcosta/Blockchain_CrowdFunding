    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        ...
        <div className='flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]'>
            <CountBox title="Days Left" value={remainingDays > 0? remainingDays : 'Over'}/>
            ...
            <div>
             ...
             <div className="mt-[20px] flex flex-col gap-4">
                 ...
                 {donators.length > 0 ? donators.map((item,index) => (
                      <div key={`${item.donator}-${index}`} className='flex justify-between items-center gap-4 flex-wrap'>
                         <p className='font-epilogue font-normal sm:text-[16px] text-[12px] text-[#b2b3bd] leading-[26px]'>{index + 1}.{item.donator}</p>
            ...
            <div className='mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]'>
                ...
                <div className="mt-[30px]">
                  ...
                  <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px]">
                      <h4 className='font-epilogue font-semibold text-[14px] leading-[22px] text-white'>Back it because you beleive in it.</h4> 
                      <p className='mt-[20px] font-epilogue font-normal leading-[22px] text-[#808191]'>Suppport the project for no reward, just because it speaks to you.</p>
                  </div>
