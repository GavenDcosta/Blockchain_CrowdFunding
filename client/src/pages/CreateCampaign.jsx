...
import { ethers } from 'ethers'    //utility library that allows us to interact with our smart contract
...
const CreateCampaign = () => {
  ...
  const handleSubmit = async (e) => {
      ...
      checkIfImage(form.image, async (exists) => {
          if(exists) {
            setIsLoading(true)
            await createCampaign({...form, target: ethers.utils.parseUnits(form.target, 18)})   //passing it in proper format, 18 = weigh of 1 ETH
            setIsLoading(false)
            navigate('/')
          }else{
