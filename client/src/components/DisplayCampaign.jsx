...
const DisplayCampaign = ({ title, isLoading, campaigns }) => {
  ...
  const handleNavigate = (campaign, count, index) => {
    navigate(`/campaign-details/${campaign.title}`, {
      state: { ...campaign, count, index },
    }); //sending state through routing, can retrive this state with useLocation Hook
  };
    ...
    <div>
      ...
      <div className="flex flex-wrap mt-[20px] gap-[26px]">
        ...
        {!isLoading && campaigns.length === 0 && (
          <p className="font-epilogue font-semibold text-[14px] leading-[30px] text-[#131313]">
